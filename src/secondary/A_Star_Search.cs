...
namespace AStarSearch
{
    ...
    public static class AStarThink
    {
        ...
        public static List<Tuple<string, string>> A_Star_Think(Affecter characterAffecter, ActionKeyMap<KeyCode> actionKeyMap, Node start, string goalEmotion, double stepMultiplier = 1, int maxQueueSize = 10000)
        {
        ...
        private static List<Tuple<double, Node>> PuppitorAdjacencies(Affecter characterAffecter, ActionKeyMap<KeyCode> actionKeyMap, Dictionary<string, double> nodeAffectVector, string goalEmotion, double stepMultiplier)
        {
